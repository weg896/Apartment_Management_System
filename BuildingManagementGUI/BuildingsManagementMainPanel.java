...
public class BuildingsManagementMainPanel extends JPanel {
	...
	public BuildingsManagementMainPanel(int id){
		...
		BuildingsManagmentPanel panel = new BuildingsManagmentPanel(id);
		pnl1.add(panel);			
