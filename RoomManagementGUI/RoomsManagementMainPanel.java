...
public class RoomsManagementMainPanel extends JPanel {
	...
	public RoomsManagementMainPanel(BuildingData building){
		...
		RoomsManagementPanel panel = new RoomsManagementPanel(building);
		pnl1.add(panel);			
