...
public class Database 
{
	 ...
	 * Host server name
	 */
	private static String serverName = "edjo.usask.ca";
	
	/**
	 * Database username
	 */
	private static String userName = "cmpt370_group03";
	
	/**
	 * Database name
	 */
	private static String dbName = "cmpt370_group03";
	
	/**
	 * Database password
	 */
	private static String password = "rig6d8l144";
	...
	public static void main(String[] argv)
	{
		...
		try 
		{
			...
			while (rs.next())
			{
				...
				System.out.print(rs.getString("u_first_name") + "\n");
